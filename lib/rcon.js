...
var Rcon = /** @class */ (function (_super) {
    ...
    function Rcon(host, port, password, keepAlive) {
        if (keepAlive === void 0) { keepAlive = 0; }
        ...
        _this.keepAliveTime = keepAlive;
        return _this;
    }
    Rcon.prototype.keepAlive = function (time) {
        var _this = this;
        if (this.hasAuthed) {
            setTimeout(function () {
                _this.send('alive');
                _this.keepAlive(time);
            }, time);
        }
    };
